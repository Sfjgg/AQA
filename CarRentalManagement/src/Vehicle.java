...
public class Vehicle {
    ...
    {
         String data = "Vehicle ID:"+this.Vehicle_id+" Year:"+String.valueOf(this.Year)+"Make:"+this.Make+" Model:"+this.Model+" Number of Seats:";
		if(this.Vehicle_id.contains("C_"))
			data+=String.valueOf(this.vehicleType.getSeats("car"))+"Status:";
		else {
            data += String.valueOf(this.vehicleType.getSeats("van")) + "Status:";
        }
        switch(this.vehicleStatus)
        {
